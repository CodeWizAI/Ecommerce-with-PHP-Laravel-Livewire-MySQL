                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <button type="submit" class="btn btn-custom2 float-right">Update Coupon</button>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="admin-heading">
                    <div class="row">
                        <div class="col-md-10">
                            <span style="padding-left: 10px">Edit Coupon</span>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label for="slug" class="col-sm-4 col-form-label"></label>
                                    <div class="col-sm-8">
                                        <button type="submit" class="btn btn-success mr-auto">Update Coupon</button>
                                    </div>
                                </div>
