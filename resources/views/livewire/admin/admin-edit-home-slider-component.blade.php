            ...
            <div class="card">
                <div class="card-header head-info">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('admin.sliders') }}" class="btn float-right btn-custom1 text-custom">Sliders List</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="text" class="form-control"  placeholder="slider title" wire:model="title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="subtitle" class="col-sm-4 col-form-label">Subitle</label>
                                    <div class="col-sm-8">
                                      <input type="text" class="form-control"  placeholder="subttitle" wire:model="subtitle"> 
                                    </div>
                                  </div>
                                ...
                                <button type="submit" class="btn btn-custom2 float-right">Update Slider</button>
                                    </div>
                                  </div>
                            </div>
                        <div class="col-md-2">
