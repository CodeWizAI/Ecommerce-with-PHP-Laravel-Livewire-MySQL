            ...
            <div class="card">
                <div class="card-header head-info">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('admin.addfeaturedproduct') }}"
                                class="btn float-right btn-custom1 text-custom">New Featured Product</a>
                        </div>
                            ...
                            <tbody>
                                @foreach ($featured_products as $product)
                                    <tr>
                                        ...
                                        <td class="nowrap"><img src="{{ asset('images/products') }}/{{ $product->image }}" alt=""
                                                width="60"></td>
                                        <td class="nowrap">{{ $product->name }}</td>
                                        <td class="nowrap">{{ $product->stock_status }}</td>
                                        <td class="nowrap">{{ $product->regular_price }}</td>
                                        <td class="nowrap">
                                            <a href="#" wire:click.prevent="removeFeaturedProduct({{ $product->id }})"
