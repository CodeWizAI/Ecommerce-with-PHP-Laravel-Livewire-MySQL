                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label for="category-name" class="col-sm-4 col-form-label">Full Name</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="slug" class="col-sm-4 col-form-label">Email</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="product-image" class="col-sm-4 col-form-label">Profile Image</label>
                                <div class="col-sm-8">
                                    <input type="file" class="input-file" wire:model="newimage">
                                    @if ($newimage)
                                        <img src="{{ $newimage->temporaryUrl() }}" width="120" alt="">
                                    @else
                                        <img src="{{ asset('images/admin') }}/{{ $image }}" width="120"
                                            alt="">
                                    @endif
                                    @error('newimage')
                                        <p class="text-danger">{{ $message }}</p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <button type="submit" class="btn btn-custom2 float-right">Update Profile</button>
